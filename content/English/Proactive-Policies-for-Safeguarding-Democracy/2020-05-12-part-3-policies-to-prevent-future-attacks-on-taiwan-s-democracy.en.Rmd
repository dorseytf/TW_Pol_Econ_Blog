...
The results of this conservative simulation suggest that a JG would have widespread benefits for Taiwan's political economy. By providing good paying jobs to the unemployed and effectively increasing the economy-wide minimum wage, the JG would help grow the economy and increase average wages for all workers by about 18%. The impact on CPI would be marginal, so the program would not be inflationary. 
